...
class translate {
    ...
    translate(language) {
        if (language == 'arabic') {
            ...
            //the translation
            document.getElementById('1').textContent = 'تسجيل دخول';
            document.getElementById('2').textContent = 'لا تمتلك حساب معنا ؟';
            document.getElementById('3').textContent = 'سجل حساب جديد';
            document.getElementById('4').textContent = 'تسجيل دخول';
            ...
            //the translation
            document.getElementById('1').textContent = 'Login';
            document.getElementById('2').textContent = "You don't have accont?";
